...
public class ReservaService {
    ...
    private void aplicarDados(Reserva reserva, ReservaRequest request) {
    ...
    private void validarConflitos(ReservaRequest request) {
        if (request.getSalaId() != null) {
